...
### argparse
# option_list <- list(
#     # make_option(c("-p", "--overall_path"), action="store_true", 
#     #     help="Path for the directory that stores the MIDAS-generated data"),
#     # make_option(c("-o", "--output_dir"), action="store_true",
#     #     help="Path for the directory that will store the outputs from this script running different benchmarking methods"),
#     # make_option(c("-o", "--or"), type="integer", default=1,
#     #     help="Odds ratio",
#     #     metavar="number"),
#     # make_option(c("-c", "--conditional_effect_val"), type="integer", default=0.299,
#     #     help="Value of the conditional effect as enforced by MIDAS",
#     #     metavar="number"),
#     # make_option(c("-b", "--batch_effect_val"), type="integer", default=0.299,
#     #     help="Value of the batch effect as enforced by MIDAS",
#     #     metavar="number"),
#     make_option(c("-i", "--iter"), type="integer", default=0.299,
#         help="iteration",
#         metavar="number"),
#     )
...
output_dir = '/athena/linglab/scratch/chf4012/simulation_data_output_norelation_TEST_090523'
