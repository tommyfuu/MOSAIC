...
if option == 1:
    ...
    for i in range(101, 1051, 50):
        ...
        if suboption == 1:
            ...
            print(f"tar cvf - {dest_dir}/range{i-50}_{i-1} | lz4 > {dest_dir}/eval_results_{datatype}_{related}_range{current_num}_{i-1}.tar.lz4")
            print(f'rclone copy {dest_dir}/eval_results_{datatype}_{related}_range{current_num}_{i-1}.tar.lz4 box_wcmc:eval_results_{datatype}_{related}_mic_bc_benchmark_sim_backup/ --progress')
